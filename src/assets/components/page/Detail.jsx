...
//
//                 if (!response.ok) {
//                     throw new Error("Failed to fetch note details"); // Gooi een fout als de aanvraag mislukt
//                 }
...
//             {/*        </div>*/}
//             {/*        <div className="flex items-center justify-between">*/}
//             {/*            <span className="text-lg font-semibold text-gray-600">Adres:</span>*/}
//             {/*            <p className="text-gray-700 mt-2">{token.adres}</p>*/}
//             {/*        </div>*/}
//             {/*    </div>*/}
//             {/*    <div className="mt-8 flex items-center justify-between">*/}
//             {/*        <Link*/}
